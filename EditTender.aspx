<%@ Page Title="" Language="C#" MasterPageFile="~/Sublayout.master" AutoEventWireup="true" CodeFile="EditTender.aspx.cs" Inherits="EditTender" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <input type="hidden" id="firmTenderGuid" />
   <input type="hidden" id="currencySelected" />
        ...
        <div class="form-data">
            ...
            <div class="fixed-information-for-tender">
                ...
                <div class="forscaste form-group">
                    <label>Date</label>
                    <input type="text" id="txtForecasteDate" />
    ...
    <a href="javascript:;" style="display: none" class="btn-SaveAllFormData hide"></a>
    <a href="javascript:;" style="display: none" class="btn-SubmitFirmData hide"></a>
    <a href="javascript:;" style="display: none" class="btnFirmReviewForm hide"></a>
    <a href="javascript:;" style="display: none" class="btn-viewFirmQuote hide"></a>
